...
contract DeployProd is BaseDeployerScript {
    struct TokenParams {
        address superAdmin;
        address minter;
    ...
    constructor() BaseDeployerScript(Environment.Production) { }
    ...
    function setUp() public {
        ...
        tokenParams = TokenParams(0x17A83578711923684485B157c9aBe8247A8F8A8c, address(0), broadcaster);
